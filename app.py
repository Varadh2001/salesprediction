...
day = st.text_input("Enter the day (1-365)")
...
if st.button("Predict"):
    prediction = model.predict([[store, item, int(day)]])
    st.write("The predicted sales for day {} at store {} for item {} is {}".format(day, store, item, prediction))
